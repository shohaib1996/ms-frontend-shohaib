...
const BenefitsCourse: React.FC<BenefitsCourseProps> = ({
    ...
    return (
        <section
            className={cn(
                'py-8 bg-gradient-to-tr from-blue-50 dark:from-blue-950 to-teal-50 dark:to-teal-950',
                className,
            )}
        >
                    ...
                    <div className='space-y-4'>
                        {title && (
                            <div className='relative'>
                                ...
                                <div className='h-1 w-20 bg-emerald-500 mt-3 rounded-full'></div>
                            </div>
                        )}
                        ...
                        >
                            {list.slice(0, visibleItems).map((benefit, i) => (
                                <motion.div
                                    key={i}
                                    className='flex items-center gap-4 p-4 rounded-xl bg-foreground shadow-sm hover:shadow-md transition-shadow duration-300'
                                    variants={item}
                                >

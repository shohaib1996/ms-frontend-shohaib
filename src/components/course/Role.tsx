...
const Role: React.FC<RoleProps> = ({ data, index, className }) => {
    ...
    return (
        <section
            className={cn(
                'xl:py-6 py-6 bg-gradient-to-b dark:from-violet-950 dark:to-purple-950 from-violet-50 to-purple-50',
                className,
            )}
        >

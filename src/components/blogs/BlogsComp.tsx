...
import TopAuthor from '@/components/blogs/new-blog/TopAuthor';
import LeftTopTrendingPost from '@/components/blogs/new-blog/LeftTopTrendingPost';
                    ...
                    <div className=''>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-12 gap-3'>
                            <div className='md:col-span-4 order-2 md:order-1'>
                                ...
                                <TagsComponent />
                                <TopAuthor setAuthorId={setAuthorId} />
                                <LeftTopTrendingPost />
                            </div>
...
BlogsComponent.displayName = 'BlogsComponent';

...
const NotificationIcon = ({ className }: { className?: string }) => {
    return (
        ...
        >
            ...
            />
            <path
                d='M11.2651 14.2949C11.2651 15.5324 10.2526 16.5449 9.01514 16.5449C8.40014 16.5449 7.83014 16.2899 7.42514 15.8849C7.02014 15.4799 6.76514 14.9099 6.76514 14.2949'
                strokeWidth='1.5'
                strokeMiterlimit='10'
            />
        </svg>
